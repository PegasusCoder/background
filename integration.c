...
int multiplayer=1;
int mutliennemie=1;
int encadrementd=1000;
int encadrementg=0;
int encadrementg2;
int encadrementd2;
	Background background,banime,back2;
	init_background(&background, background_image,&pos,&pos1,&back2, backg2im,&posb,&banime, anime) ;
...
SDL_Surface *surfM = SDL_LoadBMP("backmasque.bmp");
